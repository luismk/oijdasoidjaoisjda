...
namespace UGPangya.MessengerServer
{
    public class MPlayer : Player
    {
        ...
        public void Test23()
        {
            ...
            Response.Write(serverID); // porta que player se conectou
        ...
        {
            Response.Write(new byte[] {0x30, 0x00, 0x15, 0x01});
            Response.Write((uint) UserInfo.UID); //uid player
            Response.Write((uint) 67108864);
            ...
            Response.Write((uint) 20201); // porta que player se conectou
        ...
        internal void RequestUnknown14()
        {
            ...
            Response.Write((uint) UserInfo.UID); //uid player
            Response.Write((uint) 4);
            Response.Write((byte) 0x01);
            Response.Write((ushort) 65535);
            Response.Write((uint) 96);
            Response.Write((uint) 20201); //porta do gs, que o player se conectou
            Response.Write(new byte[]
            {
        ...
        public void PlayerSearchFriend()
        {
            ...
            if (search)
            {
                ...
                Response.Write((uint) 4276); //uid do player?
                SendResponse();
            }
