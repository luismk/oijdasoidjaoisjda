...
namespace UGPangya.API.Repository.DapperExt
{
    public static class DapperExt
    {
        public static object UpdateFields<T>(this IDbConnection connection, object param,
            IDbTransaction transaction = null, int? commandTimeOut = null, CommandType? commandType = null)
        {
            ...
            {
                var sql = string.Format("UPDATE {1} SET {0} WHERE Id=@Id", string.Join(",", names.Select(t =>
                {
                    t = t + "=@" + t;
                    return t;
                })), typeof(T).Name);
        ...
        public static object UpdateFields<T>(this IDbConnection connection, object fields,
            CommandDefinition commandDefinition)
        {
            return UpdateFields<T>(connection, fields, commandDefinition.Transaction, commandDefinition.CommandTimeout,
