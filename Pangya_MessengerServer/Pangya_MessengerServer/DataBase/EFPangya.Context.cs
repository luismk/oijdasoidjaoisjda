...
namespace Pangya_MessengerServer.DataBase
{
    ...
    public partial class PangyaEntities : DbContext
    {
        ...
        public virtual ObjectResult<ProcAlterDaily_Result> ProcAlterDaily(Nullable<int> uID, Nullable<byte> tYPE)
        {
            var uIDParameter = uID.HasValue ?
                new ObjectParameter("UID", uID) :
                new ObjectParameter("UID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ProcAlterDaily_Result>("ProcAlterDaily", uIDParameter, tYPEParameter);
        }
        ...
        public virtual ObjectResult<Nullable<decimal>> ProcGetLockerItem(Nullable<int> uID, Nullable<int> pAGE, Nullable<int> pAGE_TOTAL)
        {
            var uIDParameter = uID.HasValue ?
                new ObjectParameter("UID", uID) :
                new ObjectParameter("UID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("ProcGetLockerItem", uIDParameter, pAGEParameter, pAGE_TOTALParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> ProcGetMail(Nullable<int> uID, Nullable<int> pAGE, Nullable<int> tOTAL, Nullable<byte> rEAD)
        {
            var uIDParameter = uID.HasValue ?
                new ObjectParameter("UID", uID) :
                new ObjectParameter("UID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("ProcGetMail", uIDParameter, pAGEParameter, tOTALParameter, rEADParameter);
        }
        ...
        public virtual int USP_FIRST_CREATION(Nullable<int> uID, Nullable<int> cHAR_TYPEID, Nullable<byte> hAIRCOLOUR, string nICKNAME)
        {
            var uIDParameter = uID.HasValue ?
                new ObjectParameter("UID", uID) :
                new ObjectParameter("UID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("USP_FIRST_CREATION", uIDParameter, cHAR_TYPEIDParameter, hAIRCOLOURParameter, nICKNAMEParameter);
        }
        ...
        public virtual ObjectResult<Nullable<int>> USP_INVEN_POP(Nullable<int> uID, Nullable<int> iNV_ID)
        {
            var uIDParameter = uID.HasValue ?
                new ObjectParameter("UID", uID) :
                new ObjectParameter("UID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("USP_INVEN_POP", uIDParameter, iNV_IDParameter);
        }
